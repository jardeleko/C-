...
Esta aprendizagem partiu de um curso da plataforma "Udemy.com" com professor Marcos Castro, assim como o restando neste repositorio em especifico. 
É de importância deixar definido minha opinião em relação a educação a distancia vide que acredito nos metodos presenciais da mesma forma que acredito na força da comunidade opensource, porem todo aprendizado é valido.
